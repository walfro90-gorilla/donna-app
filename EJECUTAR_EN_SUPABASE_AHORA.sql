-- ============================================================================
-- ⚠️  EJECUTAR ESTE SCRIPT EN SUPABASE SQL EDITOR ⚠️
-- ============================================================================
-- PROPÓSITO: Agregar columnas de MercadoPago a tabla 'payments'
-- FECHA: 2025-01-16
-- ============================================================================

-- ✅ PASO 1: Agregar columnas de MercadoPago a tabla 'payments'
...
-- ✅ VERIFICACIÓN: Consultar estructura de tabla actualizada
