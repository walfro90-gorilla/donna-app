-- ============================================================================
-- Actualiza get_order_full_details para incluir is_removed en order_items.
-- Necesario para que cliente y repartidor vean ítems quitados por la cocina.
-- Requiere: 2026-03-13_ADD_order_items_is_removed.sql ya ejecutado.
-- ============================================================================
...
BEGIN
  SELECT jsonb_build_object(
    ...
    'restaurant', CASE
      WHEN r.id IS NOT NULL THEN
        jsonb_build_object(
          ...
          'delivery_time', r.estimated_delivery_time_minutes,
    ...
    -- Order Items — ahora incluye is_removed para cliente y repartidor
