-- ============================================================================
-- FIX: Actualizar función mark_order_not_delivered con firma correcta
-- ============================================================================
-- Este script corrige la firma de la función RPC mark_order_not_delivered
-- para que coincida con los parámetros que envía la app Flutter.
--
-- IMPORTANTE: 
-- - La función ya existe en la base de datos pero con parámetros incorrectos
-- - Este script reemplaza la función existente con la firma correcta
-- - NO es necesario correr los scripts anteriores si ya fueron ejecutados
--
-- INSTRUCCIONES:
