-- ============================================================================
-- FASE 2 - SCRIPT 04: CREAR FUNCIÓN MAESTRA DE SIGNUP
-- ============================================================================
-- Descripción: Crea una función maestra atómica que maneja signup para
--              los 3 tipos de usuarios: cliente, restaurante, repartidor.
-- ============================================================================
...
COMMENT ON FUNCTION public.master_handle_signup() IS 
  'Función maestra de signup. Crea automáticamente public.users + profile según rol (cliente/restaurante/repartidor). Atómica con rollback en caso de error.';

-- ============================================================================
-- PERMISOS
-- ============================================================================

-- Esta función solo debe ser ejecutada por el trigger (como postgres)
...
BEGIN
  ...
  RAISE NOTICE 'Roles soportados: cliente, restaurante, repartidor, admin';
  RAISE NOTICE 'Comportamiento: Atómico con rollback en caso de error';
  RAISE NOTICE '';
  RAISE NOTICE '✅ Puedes continuar con el script 05_implementation_replace_trigger.sql';
END $$;
