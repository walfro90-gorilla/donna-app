-- fix_ambiguous_register_delivery_agent.sql
-- Purpose: Remove ALL overloaded versions of public.register_delivery_agent to avoid
--          "function name is not unique" ambiguity before recreating the canonical RPC.
