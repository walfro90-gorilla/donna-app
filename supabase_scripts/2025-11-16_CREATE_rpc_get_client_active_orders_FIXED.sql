-- ============================================================================
-- FUNCIÓN RPC: get_client_active_orders
-- ============================================================================
-- PROPÓSITO: Obtener todas las órdenes activas de un cliente con información
--            completa del delivery agent (nombre y teléfono desde users)
-- FECHA: 2025-11-16
-- AUTOR: Hologram
-- ============================================================================
