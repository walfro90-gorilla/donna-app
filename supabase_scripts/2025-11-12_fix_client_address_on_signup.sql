...
-- Descripción: Actualiza master_handle_signup() para almacenar correctamente
...
--
-- SOLUCIÓN: Actualizar la función master_handle_signup() para extraer
...
BEGIN
  ...
  RAISE NOTICE '🔧 Eliminando % versiones de master_handle_signup()', v_function_count;
  
  -- Eliminar todas las versiones
  DROP FUNCTION IF EXISTS public.master_handle_signup() CASCADE;
  
  RAISE NOTICE '✅ Función eliminada correctamente';
END $$;

-- ============================================================================
-- PASO 2: Crear la función desde cero con soporte para dirección
-- ============================================================================
...
-- ============================================================================
-- PASO 3: Verificar que el trigger existe y está apuntando a la función
-- ============================================================================
...
SELECT 
  '✅ VERIFICACIÓN DE COLUMNAS EN client_profiles' as status,
  column_name,
  data_type,
  is_nullable
