-- ============================================================================
-- FIX: Buscar cuentas de plataforma DIRECTAMENTE por account_type
-- ============================================================================
-- PROBLEMA: El script anterior buscaba con JOIN a users y verificando email,
--           pero según el schema, basta con buscar directamente en accounts
--           WHERE account_type = 'platform_revenue' o 'platform_payables'
--           ya que estos tipos son únicos en el sistema.
--           
-- SOLUCIÓN: Búsqueda directa por account_type sin JOINs innecesarios.
-- ============================================================================
...
-- Paso 2: Crear función CORRECTA buscando SOLO por account_type
...
-- VERIFICACIÓN
-- ============================================================================
-- Para verificar que los accounts de plataforma existen:
...
-- FROM pg_trigger 
-- WHERE tgname LIKE '%payment%' AND tgrelid = 'orders'::regclass;
-- ============================================================================
