      ...
      return Container(
        ...
        child: Row(
          children: [
            ...
            Icon(Icons.stars, color: Colors.white.withOpacity(0.5), size: 18),
          ],
        ),
      );
    }
          ...
          children: [
            ...
            Expanded(
              child: Text(
                label,
                style: TextStyle(
                  color: isDone ? Colors.white.withOpacity(0.9) : Colors.white54,
                  fontSize: 14,
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(color: status.color.withOpacity(0.7), fontSize: 12),
                ),
              ],
            ),
          ),
